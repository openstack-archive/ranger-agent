...
SERVICE_OPTS = [
    cfg.StrOpt('project_id', default='',
               help="project id used by ranger-agent driver of service vm extension"),
    cfg.StrOpt('auth_url', default='http://0.0.0.0:5000/v2.0',
               help="auth URL used by ranger-agent driver of service vm extension"),
    cfg.StrOpt('user_name', default='',
               help="user name used by ranger-agent driver of service vm extension"),
    cfg.StrOpt('password', default='',
               help="password used by ranger-agent driver of service vm extension"),
